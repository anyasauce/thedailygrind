...
<head>
    ...
    <title>The Daily Grind | Login</title>
                ...
                <div class="card shadow-lg p-4">
                    ...
                    <form action="<?= route('controllers', 'auth_controller') ?>" class="needs-validation" novalidate method="POST">
                        ...
                        <div class="d-flex justify-content-between mb-4" data-aos="fade-up" data-aos-duration="600"
                            ...
                            <a href="#" class="form-link" data-bs-toggle="modal" data-bs-target="#forgotPasswordModal">Forgot Password?</a>
                        </div>

                        <button type="submit" name="login" class="btn btn-primary w-100 py-2"
                            data-aos="fade-up" data-aos-duration="600" data-aos-delay="1100">
